...
class Admin_Interface extends Admin_UI
{
			...
			switch ( trim( $_REQUEST['type'] ) ) {
				...
				case 'check_new_version':
					...
					if ( '' == trim( $version_message ) ) {
						$version_message = __( 'Great! You have the latest version installed.', 'woocommerce-compare-products' );
						$has_new_version = 0;
					} else {
	...
	public function get_success_message( $message = '' ) {
		if ( trim( $message ) == '' ) $message = __( 'Settings successfully saved.' , 'woocommerce-compare-products' ); 
	...
	public function get_error_message( $message = '' ) {
		if ( trim( $message ) == '' ) $message = __( 'Error: Settings can not save.' , 'woocommerce-compare-products' ); 
	...
	public function get_reset_message( $message = '' ) {
		if ( trim( $message ) == '' ) $message = __( 'Settings successfully reseted.' , 'woocommerce-compare-products' ); 
		return '<div class="updated" id=""><p>' . $message . '</p></div>';
	}
	...
	public function get_font_weights() {
		$font_weights = array (
			'300'				=> __( 'Thin', 'woocommerce-compare-products' ),
			'300 italic'		=> __( 'Thin/Italic', 'woocommerce-compare-products' ),
			'normal'			=> __( 'Normal', 'woocommerce-compare-products' ),
			'italic'			=> __( 'Italic', 'woocommerce-compare-products' ),
			'bold'				=> __( 'Bold', 'woocommerce-compare-products' ),
			'bold italic'		=> __( 'Bold/Italic', 'woocommerce-compare-products' ),
		);
	...
	public function get_border_styles() {
		$border_styles = array (
			'solid'				=> __( 'Solid', 'woocommerce-compare-products' ),
			'double'			=> __( 'Double', 'woocommerce-compare-products' ),
			'dashed'			=> __( 'Dashed', 'woocommerce-compare-products' ),
			'dotted'			=> __( 'Dotted', 'woocommerce-compare-products' ),
			'groove'			=> __( 'Groove', 'woocommerce-compare-products' ),
			'ridge'				=> __( 'Ridge', 'woocommerce-compare-products' ),
			'inset'				=> __( 'Inset', 'woocommerce-compare-products' ),
			'outset'			=> __( 'Outset', 'woocommerce-compare-products' ),
		);
	...
	public function admin_forms( $options, $form_key, $option_name = '', $form_messages = array() ) {
		...
		foreach ( $options as $value ) {
			...
			switch( $value['type'] ) {
				...
				case 'google_api_key':
					...
					if ( ! isset( $value['checked_label'] ) ) $value['checked_label'] = __( 'ON', 'woocommerce-compare-products' );
					if ( ! isset( $value['unchecked_label'] ) ) $value['unchecked_label'] = __( 'OFF', 'woocommerce-compare-products' );

					?><tr valign="top">
						<th scope="row" class="titledesc">
                        	<?php echo $tip; /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?>
							<label for="<?php echo esc_attr( $this->google_api_key_option ); ?>"><?php echo __( 'Google Fonts API', 'woocommerce-compare-products' ); ?></label>
						</th>
						<td class="forminp forminp-onoff_checkbox forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
							<input
								...
								/> <span class="description" style="margin-left:5px;"><?php echo __( 'ON to connect to Google Fonts API and have auto font updates direct from Google.', 'woocommerce-compare-products' ); ?></span>
							...
							<div class="a3rev-ui-google-api-key-container" style="<?php if( 1 != $google_api_key_enable ) { echo 'display: none;'; } ?>">
								...
								<div class="a3rev-ui-google-api-key-inside 
									...
									<input
		                                ...
		                                placeholder="<?php echo __( 'Google Fonts API Key', 'woocommerce-compare-products' ); ?>"
										<?php echo implode( ' ', $custom_attributes );	// XSS ok ?>
										/>
									<p class="a3rev-ui-google-valid-key-message"><?php echo __( 'Your Google API Key is valid and automatic font updates are enabled.', 'woocommerce-compare-products' ); ?></p>
									<p class="a3rev-ui-google-unvalid-key-message"><?php echo __( 'Please enter a valid Google API Key.', 'woocommerce-compare-products' ); ?></p>
								</div>
							</div>
						</td>
					</tr><?php
				...
				case 'google_map_api_key':
					...
					?><tr valign="top">
						<th scope="row" class="titledesc">
                        	<?php echo $tip; /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?>
							<label for="<?php echo esc_attr( $this->google_map_api_key_option ); ?>"><?php echo __( 'Google Maps API', 'woocommerce-compare-products' ); ?></label>
						</th>
						<td class="forminp forminp-onoff_checkbox forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
							<input
								...
								/> <span class="description" style="margin-left:5px;"><?php echo __( 'Switch ON to connect to Google Maps API', 'woocommerce-compare-products' ); ?></span>

							<div>&nbsp;</div>
							<div class="a3rev-ui-google-api-key-container" style="<?php if( 1 != $google_map_api_key_enable ) { echo 'display: none;'; } ?>">
								<div class="a3rev-ui-google-api-key-description"><?php echo sprintf( __( "Enter your existing Google Map API Key below. Don't have a key? Visit <a href='%s' target='_blank'>Google Maps API</a> to create a key", 'woocommerce-compare-products' ), 'https://developers.google.com/maps/documentation/javascript/get-api-key' ); ?></div>
								<div class="a3rev-ui-google-api-key-inside 
									<?php
									...
									<input
										...
										class="a3rev-ui-text a3rev-ui-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?> <?php echo esc_attr( $value['class'] ); ?>"
		                                placeholder="<?php echo __( 'Google Map API Key', 'woocommerce-compare-products' ); ?>"
										<?php echo implode( ' ', $custom_attributes );	// XSS ok ?>
										/>
									<p class="a3rev-ui-google-valid-key-message"><?php echo __( 'Your Google API Key is valid and automatic font updates are enabled.', 'woocommerce-compare-products' ); ?></p>
									<p class="a3rev-ui-google-unvalid-key-message"><?php echo __( 'Please enter a valid Google API Key.', 'woocommerce-compare-products' ); ?></p>
				...
				case 'manual_check_version':
					...
					if ( is_multisite() ) {
						$version_message = __( 'Sorry, this feature just for Network Admin.', 'woocommerce-compare-products' );
					} else {
						global $a3_dashboard_plugin_requirement;

						if ( ! $a3_dashboard_plugin_requirement->is_installed() ) {
							$version_message = sprintf( __( 'You need to install and activate the <a title="" href="%s" target="_parent">a3rev Dashboard plugin</a> for manage version and get auto upgrade to latest version.', 'woocommerce-compare-products' ), $a3_dashboard_plugin_requirement->install_url() );
						} elseif ( ! $a3_dashboard_plugin_requirement->is_activated() ) {
							$version_message = sprintf( __( 'You need to activate the <a title="" href="%s" target="_parent">a3rev Dashboard plugin</a> for manage version and get auto upgrade to latest version.', 'woocommerce-compare-products' ), $a3_dashboard_plugin_requirement->activate_url() );
						} elseif ( function_exists( 'is_a3_club_membership' ) && ! is_a3_club_membership() ) {
							$version_message = sprintf( __( 'You need to go to <a title="" href="%s">a3 Dashboard Main page</a> for login before check for Update. Use your account creds on <a href="https://a3rev.com" target="_parent">a3rev.com</a> to login.', 'woocommerce-compare-products' ), self_admin_url( 'admin.php?page=a3rev-dashboard' ) );
						} else {
							$check_version_class = 'a3rev-ui-latest-version-message';
							$version_message = sprintf( __( 'Go to <a href="%s">a3 Dashboard Main page</a> and hit on <strong>CHECK NOW</strong> button to manual check for Update.', 'woocommerce-compare-products' ), self_admin_url( 'admin.php?page=a3rev-dashboard' ) );
						}
					}
				...
				case 'onoff_toggle_box' :
					...
					?><tr valign="top">
						<th scope="row" class="titledesc">
                        	<?php echo $tip; /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?>
							<label for="<?php echo esc_attr( $this->toggle_box_open_option ); ?>"><?php echo __( 'Open Box Display', 'woocommerce-compare-products' ); ?></label>
						</th>
						<td class="forminp forminp-onoff_checkbox forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
							<input
								...
								<?php echo implode( ' ', $custom_attributes );	// XSS ok ?>
								/> <span class="description" style="margin-left:5px;"><?php echo __( 'ON and each admin panel setting box OPEN | CLOSED position are saved each time changes are SAVED.', 'woocommerce-compare-products' ); ?></span>
                        </td>
					</tr><?php
				break;
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
							<input
									...
									checked_label="<?php _e( 'ON', 'woocommerce-compare-products' ); ?>"
									unchecked_label="<?php _e( 'OFF', 'woocommerce-compare-products' ); ?>"
									type="checkbox"
									value="1"
							...
							<fieldset>
								...
								if ( is_array( $value['onoff_options'] ) && count( $value['onoff_options'] ) > 0 ) {
									foreach ( $value['onoff_options'] as $i_option ) {
										if ( ! isset( $i_option['checked_label'] ) ) $i_option['checked_label'] = __( 'ON', 'woocommerce-compare-products' );
										if ( ! isset( $i_option['unchecked_label'] ) ) $i_option['unchecked_label'] = __( 'OFF', 'woocommerce-compare-products' );
				...
				case 'image_size' :
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
							...
							<label><?php _e( 'Width', 'woocommerce-compare-products' ); ?> <input name="<?php echo $name_attribute; ?>[width]" id="<?php echo esc_attr( $id_attribute ); ?>-width" type="text" class="a3rev-ui-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>-width" value="<?php echo esc_attr( $width ); ?>" /></label>
	
							<label><?php _e( 'Height', 'woocommerce-compare-products' ); ?> <input name="<?php echo $name_attribute; ?>[height]" id="<?php echo esc_attr( $id_attribute ); ?>-height" type="text" class="a3rev-ui-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>-height" value="<?php echo esc_attr( $height ); ?>" /></label>
	
							<label><?php _e( 'Hard Crop', 'woocommerce-compare-products' ); ?> <input name="<?php echo $name_attribute; ?>[crop]" id="<?php echo esc_attr( $id_attribute ); ?>-crop" type="checkbox" class="a3rev-ui-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>-crop" <?php echo $crop; ?> /></label>
				...
				case 'typography':
					...
					?><tr valign="top">
						...
						<td class="forminp">
                           ...
                           <!-- Preview Button -->
                           <div class="a3rev-ui-typography-preview"><a href="#" class="a3rev-ui-typography-preview-button button submit-button" title="<?php _e( 'Preview your customized typography settings', 'woocommerce-compare-products'); ?>"><span>&nbsp;</span></a></div>
				...
				case 'border':
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-border_corner">
                           ...
                           <!-- Preview Button -->
                           <div class="a3rev-ui-settings-preview"><a href="#" class="a3rev-ui-border-preview-button a3rev-ui-settings-preview-button button submit-button" title="<?php _e( 'Preview your customized border settings', 'woocommerce-compare-products' ); ?>"><span>&nbsp;</span></a></div>
                           <span class="description" style="margin-left:5px;"><?php echo __( '0px = No Border', 'woocommerce-compare-products' ); ?></span>
                           ...
                           <!-- Border Corner : Rounded or Square -->
								<input
                                    ...
                                    checked_label="<?php _e( 'Rounded', 'woocommerce-compare-products' ); ?>"
                                    unchecked_label="<?php _e( 'Square', 'woocommerce-compare-products' ); ?>"
                                    type="checkbox"
                                    value="rounded"
							...
							<!-- Border Rounded Value -->
								<div class="a3rev-ui-border-corner-value-container">
                                	<div class="a3rev-ui-border_corner-top_left">
                                        <span class="a3rev-ui-border_corner-span"><?php _e( 'Top Left Corner', 'woocommerce-compare-products' ); ?></span>
                                    ...
                                    <div class="a3rev-ui-border_corner-top_right">
                                        <span class="a3rev-ui-border_corner-span"><?php _e( 'Top Right Corner', 'woocommerce-compare-products' ); ?></span> 
                                        <div class="a3rev-ui-slide-container">
                                            <div class="a3rev-ui-slide-container-start">
                                                <div class="a3rev-ui-slide-container-end">
                                    ...
                                    <div class="a3rev-ui-border_corner-bottom_right">
                                        <span class="a3rev-ui-border_corner-span"><?php _e( 'Bottom Right Corner', 'woocommerce-compare-products' ); ?></span> 
                                        <div class="a3rev-ui-slide-container">
                                            <div class="a3rev-ui-slide-container-start">
                                                <div class="a3rev-ui-slide-container-end">
                                    ...
                                    <div class="a3rev-ui-border_corner-bottom_left">
                                        <span class="a3rev-ui-border_corner-span"><?php _e( 'Bottom Left Corner', 'woocommerce-compare-products' ); ?></span>
                                        <div class="a3rev-ui-slide-container"> 
                                            <div class="a3rev-ui-slide-container-start">
                                                <div class="a3rev-ui-slide-container-end">
				...
				case 'border_styles':
					...
					?><tr valign="top">
						...
						<td class="forminp">
                           ...
                           <!-- Preview Button -->
                           <div class="a3rev-ui-settings-preview"><a href="#" class="a3rev-ui-border-preview-button a3rev-ui-settings-preview-button button submit-button" title="<?php _e( 'Preview your customized border styles settings', 'woocommerce-compare-products' ); ?>"><span>&nbsp;</span></a></div>
                           <span class="description" style="margin-left:5px;"><?php echo __( '0px = No Border', 'woocommerce-compare-products' ); ?></span>
                           </div>
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-box_shadow">
							...
							<select
                                ...
                                data-placeholder="<?php _e( 'Horizontal Shadow', 'woocommerce-compare-products' ); ?>"
								>
								<?php
									for ( $i = -20; $i <= 20; $i++ ) {
										?>
							...
							<select
                                ...
                                data-placeholder="<?php _e( 'Vertical Shadow', 'woocommerce-compare-products' ); ?>"
								>
								<?php
									for ( $i = -20; $i <= 20; $i++ ) {
										?>
                           ...
                           <!-- Box Blur Distance -->
							<select
                                ...
                                data-placeholder="<?php _e( 'Blur Distance', 'woocommerce-compare-products' ); ?>"
								>
								<?php
									for ( $i = 0; $i <= 20; $i++ ) {
										?>
                           ...
                           <!-- Box Spread -->
							<select
                                ...
                                data-placeholder="<?php _e( 'Spread Size', 'woocommerce-compare-products' ); ?>"
								>
								<?php
									for ( $i = 0; $i <= 20; $i++ ) {
										?>
                           ...
                           <!-- Box Shadow Inset -->
                                <input
                                    ...
                                    checked_label="<?php _e( 'INNER', 'woocommerce-compare-products' ); ?>"
                                    unchecked_label="<?php _e( 'OUTER', 'woocommerce-compare-products' ); ?>"
                                    type="checkbox"
                                    value="inset"
                           ...
                           <input
                            ...
                            <!-- Preview Button -->
                           <div class="a3rev-ui-settings-preview"><a href="#" class="a3rev-ui-box_shadow-preview-button a3rev-ui-settings-preview-button button submit-button" title="<?php _e( 'Preview your customized box shadow settings', 'woocommerce-compare-products'); ?>"><span>&nbsp;</span></a></div>   
                           </div>
                           <div style="clear:both;"></div>
                           </div>
						</td>
		...
		<?php do_action( $this->plugin_name . '-' . trim( $form_key ) . '_settings_end' ); ?>
            <p class="submit">
                    <input type="submit" value="<?php _e('Save changes', 'woocommerce-compare-products'); ?>" class="button button-primary" name="bt_save_settings" />
                    <input type="submit" name="bt_reset_settings" class="button" value="<?php _e('Reset Settings', 'woocommerce-compare-products'); ?>"  />
