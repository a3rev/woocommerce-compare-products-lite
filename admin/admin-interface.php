		...
		if ( isset( $_REQUEST['type'] ) ) {
			switch ( trim( $_REQUEST['type'] ) ) {
				...
				case 'check_new_version':
					...
					$new_version = '';
					if ( class_exists( 'WC_Compare_Upgrade' ) ) {
						$new_version = WC_Compare_Upgrade::get_version_info();
					}
			...
			switch( $value['type'] ) {
				...
				case 'manual_check_version':
					...
					?><tr valign="top">
						<th scope="row" class="titledesc">
                        	<?php echo $tip; ?>
							<label><?php echo __( 'Check New Version', 'woocommerce-compare-products' ); ?></label>
						</th>
						<td class="forminp forminp-manual_check_version">
							...
							<input
                                ...
                                type="button"
								value="<?php echo __( 'Check Now', 'woocommerce-compare-products' ); ?>"
